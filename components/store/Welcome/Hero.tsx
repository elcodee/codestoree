  ...
  return (
    <>
      <div
        ...
        style={{ maxWidth: "1200px", marginBottom: -150 }}
      >
        <p className="text-xl mb-5">Welcome</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-5 font-bold heroShinyBg">
          {/* I enjoy */}
           <span className="heroShiny1 text-fun-pink">Code Store</span>
          {/* <span className="heroShiny2 text-fun-pink">designing</span>  */}
          <img
        ...
        Code Store Specialist Game Mobile Legends Terpercaya, Murah , Aman Dan Legal 100% Open 24 Jam.
        </p>
        <ScrollLink
          activeClass="active"
          to="learnmore"
